...
export const ChatSupport = ({ isOpen = true, onClose }: ChatSupportProps) => {
    ...
    <AnimatePresence>
      {isOpen && (
        <motion.div 
          ...
          className="fixed bottom-6 right-6 z-50 w-[400px] max-w-[calc(100vw-48px)] h-[600px] max-h-[calc(100vh-100px)] bg-white dark:bg-card rounded-2xl shadow-2xl overflow-hidden border border-gray-100 dark:border-white/10 flex flex-col"
        >
          {/* Header */}
