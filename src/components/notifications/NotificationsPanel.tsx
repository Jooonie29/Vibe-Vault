        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    className="absolute top-full right-0 mt-2 w-80 sm:w-96 bg-white dark:bg-gray-900 rounded-2xl shadow-2xl border border-gray-100 dark:border-gray-800 overflow-hidden z-50"
                >
                    {/* Header */}
